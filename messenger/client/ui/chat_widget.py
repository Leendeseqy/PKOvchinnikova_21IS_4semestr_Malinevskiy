...
try:
    from config import SERVER_URL, WEBSOCKET_URL, APP_NAME
    from models.message import Message
    from network.websocket_client import MessengerWebSocket
...
if __name__ == "__main__":
    ...
    widget = ChatWidget("test_token", test_user, test_contact, "http://127.0.0.1:8000")
    widget.show()
